  ...
  return (
    <html lang="pt-BR">
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
              ...
              })(window,document,'script','dataLayer','GTM-5R8S5VF');`
          }}
        />
        <script
          dangerouslySetInnerHTML={{
      ...
      <body>
        <noscript
          dangerouslySetInnerHTML={{
            __html: `<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PH25RMN" height="0" width="0" style="display:none;visibility:hidden"></iframe>`
          }}
        />
