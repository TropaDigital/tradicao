...
export function InfoImovel({data, handleInputChange, handleOnChangeCheckbox}: Props) {
  return (
...
export function ConfirmImovel({data, handleInputChange, handleOnChangeCheckbox}: Props) {
  return (
    <fieldset style={{ marginTop: '0px' }}>
      <legend className="isSubInfo">
        <MovelIcon />
